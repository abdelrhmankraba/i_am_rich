        ...
        return Scaffold(
          ...
          body: ConditionalBuilder(
            ...
            builder:(context) => ListView.separated(
              ...
              itemBuilder: (context , index) => buildListProduct(ShopCubit.get(context).preventCorona!.data!.data![index],context),
              ...
              itemCount: ShopCubit.get(context).preventCorona!.data!.data!.length,
            ),
