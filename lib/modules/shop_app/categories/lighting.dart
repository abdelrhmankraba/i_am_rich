        ...
        return Scaffold(
          ...
          body: ConditionalBuilder(
            ...
            builder:(context) => ListView.separated(
              ...
              itemBuilder: (context , index) => buildListProduct(ShopCubit.get(context).lighting!.data!.data![index],context),
              ...
              itemCount: ShopCubit.get(context).lighting!.data!.data!.length,
            ),
